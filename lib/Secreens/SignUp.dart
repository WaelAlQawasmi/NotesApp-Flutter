...
shape: Border(bottom: BorderSide(color: Colors.greenAccent,width: 1)),
        title: Center(child: Text("Sign up",style: TextStyle(color: Colors.black54),)),
      ),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: Color(0xFFF1F8E9),borderRadius: BorderRadius.circular(25)),
                  ...
                  child: Column(
                    ...
                    children: [
                      Image(image: NetworkImage("https://www.pngmart.com/files/7/Note-PNG-Clipart.png"),height: 150,),
                      TextFormField(
                        validator: (value) {
...
Padding(padding: EdgeInsets.all(10)),
                      ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(backgroundColor: Color(0xFFC8E6C9),minimumSize: Size(380,50)),
